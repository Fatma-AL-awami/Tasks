...
class two_Fragment : Fragment() {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            taskListViewModel.task2ListLiveData.observe(
                viewLifecycleOwner,
                Observer { task ->
                    task?.let {
        ...
        private inner class CrimeHolder(view: View) : RecyclerView.ViewHolder(view),
            ...
            val titleTextView: TextView = itemView.findViewById(R.id.Task2_Title)
            val detailsTextView: TextView = itemView.findViewById(R.id.Task2_details)
            val dateTextView: TextView = itemView.findViewById(R.id.Task2_date)
